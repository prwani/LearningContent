"""Level 5 — Azure OpenAI Chat Completions: Meta-Tool Registry for 50+ tools (3+ turns).
...
print("=== Azure OpenAI Chat Completions — Meta-Tool Registry (3+ turns) ===\n")
...
for qi, user_msg in enumerate(user_queries, 1):
    ...
    while step < 5:
        ...
        response = client.chat.completions.create(
            model=os.environ.get("AZURE_OPENAI_DEPLOYMENT", "gpt-4o-mini"), messages=messages, tools=meta_tools,
        )
